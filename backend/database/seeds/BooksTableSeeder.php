...
class BooksTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('books')->insert([[
                ...
                'publisher' => 'Packtpub',
                'cover' => 'mastering-linux-security-and-hardening.jpg',
                'price' => 125000,
                'weight' => 0.5,
                'status' => 'PUBLISH',
            ],[
                ...
                'publisher' => 'Packtpub',
                'cover' => 'mastering-postgresql-10.jpg',
                'price' => 90000,
                'weight' => 0.5,
                'status' => 'PUBLISH',
            ],[
                ...
                'publisher' => 'Packtpub',
                'cover' => 'python-programming-blueprints.jpg',
                'price' => 75000,
                'weight' => 0.5,
                 'status' => 'PUBLISH',
            ]
